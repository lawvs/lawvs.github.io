...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: "GitHub",
      url: "https://github.com/lawvs", // Internal links should not include the base path, as it is automatically added
